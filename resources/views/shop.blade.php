...
<main class="pt-90">
    <section class="shop-main container d-flex pt-4 pt-xl-5">
      <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
        ...
        {{-- <div class="accordion" id="wardrobe-filters">
          <div class="accordion-item mb-4 pb-3">
            <h5 class="accordion-header" id="accordion-heading-wardrobe">
              <button class="accordion-button p-0 border-0 fs-5 text-uppercase" type="button" data-bs-toggle="collapse"
                data-bs-target="#accordion-filter-wardrobe" aria-expanded="true" aria-controls="accordion-filter-wardrobe">
                Wardrobe
                <svg class="accordion-button__icon type2" viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg">
                  <g aria-hidden="true" stroke="none" fill-rule="evenodd">
                    <path
            ...
            <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
                <ul class="list list-inline mb-0 brand-list">
                    <li class="list-item py-2">
                      <span class="menu-link py-1">
                        <input type="checkbox" name="brands" value="men" class="chk-brand" checked="checked">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 ml-2" aria-label="Page Size" id="pagesize"
              ...
              <option value="6" {{$size == 6?'selected':''}}>Show</option>
