            ...
            <div class="wg-box">
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <div id="sizesColorsQuantities" style="max-height: 300px; overflow-y: auto;  padding: 10px;">
                            <!-- Dynamic rows will be added here -->
                        </div>
                
                        <!-- Add size button -->
                        <button class="tf-button" type="button" id="addSizeRow" >
                            Add Size
                        </button>
                    </fieldset>
        ...
        const sizeRow = `
            <div id="${sizeRowId}" class="sizeRow" style="margin-bottom: 10px; padding: 10px; border: 1px solid #ecf0f4; border-radius: 12px;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <button type="button" class="addColorRow" style="width:120px; padding: 5px 10px; background-color: #28A745; color: #fff; border: none; border-radius: 5px; cursor: pointer;">Add Color</button>
                    <button type="button" class="removeSizeRow" style="width:120px; padding: 5px 10px; background-color: #dc3545; color: #fff; border: none; border-radius: 5px; cursor: pointer;">Remove Size</button>
                </div>
...
<script>
        ...
        const sizeRow = `
            <div id="${sizeRowId}" class="sizeRow" style="margin-bottom: 10px; padding: 10px; border: 1px solid #ECF0F4; border-radius: 12px">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <button type="button" class="addColorRow" style="padding: 5px 10px; background-color: #28A745; color: #fff; border: none; border-radius: 5px; cursor: pointer; width: 120px">Add Color</button>
                    <button type="button" class="removeSizeRow" style="padding: 5px 10px; background-color: #DC3545; color: #fff; border: none; border-radius: 5px; cursor: pointer;  width: 120px">Remove Size</button>
                </div>
                <div class="colorRows" style="margin-top: 10px;"></div>
            </div>
        `;
    ...
    container.addEventListener('click', function (event) {
        if (event.target.classList.contains('addColorRow')) {
            ...
            const sizeRowIndex = Array.from(container.children).indexOf(parentSizeRow);
            const colorRow = `
                <div class="colorRow" style="margin-bottom: 5px; display: flex; align-items: center; justify-content: space-between;">
                    <label style="font-size:14px; display: flex; align-items: center; gap: 5px;">
                        Color:
                        <select name="size_color_quantity[${sizeRowIndex}][color][]" required style="padding: 5px;">
                            @foreach ($colors as $color)
                    ...
                    <button type="button" class="removeColorRow" style="padding: 5px 10px; background-color: #DC3545; color: #fff; border: none; border-radius: 5px; cursor: pointer;  width: 120px">Remove</button>
                </div>
            `;
            parentSizeRow.querySelector('.colorRows').insertAdjacentHTML('beforeend', colorRow);
        }
